...
const isUsableContent = (value?: string | null) => {
  ...
  const mojibakePattern = /[\u951F\u95B8\u95C1\u7F01\u941F\u7035\u95B9\u9227\u5A34]/g
...
const fallbackIcon = FileLock2

const localizedContent = computed(() => tm('legal.privacy') as unknown as LegalCopy)
    ...
    <section class="px-4 pb-10 pt-16 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-6xl">
        <div class="grid gap-6 rounded-lg border border-slate-200 bg-white p-7 shadow-sm dark:border-slate-800 dark:bg-slate-900 lg:grid-cols-[1.2fr_0.8fr] lg:p-10">
          <div>
            <div class="inline-flex items-center gap-2 rounded-md border border-sky-200 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.24em] text-sky-700 shadow-sm dark:border-sky-500/30 dark:bg-sky-500/10 dark:text-sky-300">
      ...
      <div class="mx-auto grid max-w-6xl gap-5 lg:grid-cols-2">
        ...
        >
          <div class="flex items-start gap-4">
            <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-md bg-sky-50 text-sky-700 dark:bg-sky-500/10 dark:text-sky-300">
